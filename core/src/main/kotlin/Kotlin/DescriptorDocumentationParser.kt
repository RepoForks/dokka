                             ...
                             val sampleService: SampleProcessingService)
{
    ...
    fun parseDocumentationAndDetails(descriptor: DeclarationDescriptor, inline: Boolean = false): Pair<Content, (DocumentationNode) -> Unit> {
        ...
        val content = buildContent(tree, linkMap, { href -> linkResolver.resolveContentLink(descriptor, href) }, inline)
            ...
            tags.forEach {
                when (it.knownTag) {
                    ...
                    KDocKnownTag.SEE ->
                        ...
                        buildInlineContentTo(markdownNode, section, linkMap, { href -> linkResolver.resolveContentLink(descriptor, href) })
                    }
                }
            }
        }
